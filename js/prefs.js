...
Prefs.prototype = {
	...
	_themeDefaults: {
		fancy: {
			...
			'sd.background_url_type': 'fill', //"parallax",
	...
	_defaults: {
		...
		'sd.display_dial_remove_dialog': true,
		...
		'sd.background_url_type': 'fill', // 'noimage',
	...
	remove: function (name) {
		...
		fvdSpeedDial.localStorage.removeItem(name);
	},
	...
	get: function (name, defaultValue) {
		...
		const value = fvdSpeedDial.localStorage.getItem(name);
	...
	sSet: function (name, value) {
		...
		fvdSpeedDial.localStorage.setItem(this._name(name), value);
	},
