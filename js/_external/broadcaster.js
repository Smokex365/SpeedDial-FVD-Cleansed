...
Broadcaster.prototype = {
	...
	onMessage: {
		...
		_call: function (msg, cb) {
			...
			const sender = {
				url: '', // document.location.href,  TODO ссылка на аддон передавалась? О_о
			...
			for (let i = 0; i !== this._listeners.length; i++) {
				...
				const callres = this._listeners[i].apply(this, args); // TODO либо воркер передать, если вообще используется
